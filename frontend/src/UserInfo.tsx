...
import { fetchUserData, fetchChallengeDetails } from './api';
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const updatedSolvedChallenges = await Promise.all(
                    userData.solved_challenges.map(async (challenge) => {
                        try {
                ...
                // Update user state with all challenges updated
                setUser(prevUser => ({ ...prevUser!, solved_challenges: updatedSolvedChallenges }));
            } catch (err) {
        ...
        <div className="container">
            ...
            <div className="user-level">
                ...
                <p>
                    ...
                    <span className="icon-wrapper"><FontAwesomeIcon icon={faTint} className="red-text" /> {user?.first_bloods}</span>
                </p>
            </div>
