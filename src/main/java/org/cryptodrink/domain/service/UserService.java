...
import org.cryptodrink.domain.service.cryptohack.CryptoHackResponse;
...
public class UserService {
    ...
    public Optional<UserEntity> findUserByName(String username, Boolean refreshIfEmpty)
    {
        ...
        if (user.isEmpty()) {
            ...
            if (refreshIfEmpty) {
                ...
                return findUserByName(username, false);
            }
